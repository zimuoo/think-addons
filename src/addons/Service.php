...
class Service extends \think\Service
{
    ...
    public function boot()
    {
        $this->registerRoutes(function (Route $route) {
            // 路由脚本
            $execute = '\\zimuoo\\addons\\Route::execute';
    ...
    {
        Lang::load([
            $this->app->getRootPath() . '/vendor/zimuoo/think-addons/src/lang/zh-cn.php'
        ]);
    }
    ...
    private function autoload()
    {
        ...
        // 读取插件目录及钩子列表
        $base = get_class_methods("\\zimuoo\\Addons");
        // 读取插件目录中的php文件
